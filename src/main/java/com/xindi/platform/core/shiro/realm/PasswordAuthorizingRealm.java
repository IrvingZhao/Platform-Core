...
import com.xindi.platform.core.shiro.authenInfo.PasswordAuthenticationInfo;
import com.xindi.platform.core.shiro.token.PasswordToken;
...
public class PasswordAuthorizingRealm extends AuthorizingRealm {
    ...
    @Autowired
    public PasswordAuthorizingRealm(ShiroUserService userService) {//TODO 测试 用户信息相关内容
        if (userService == null) {
