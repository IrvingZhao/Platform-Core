package com.xindi.platform.core.shiro.web;

import com.xindi.platform.core.shiro.filters.MatchOneFilter;
import com.xindi.platform.core.shiro.redirect.LoginUrlGenerator;
...
public class CustomProxiedFilterChain implements FilterChain {
    ...
    public void doFilter(ServletRequest request, ServletResponse response) throws IOException, ServletException {
        //TODO  检查 所有的filter 是不是 accessControlFilter
        if (matchOne) {
